...
class AnalizadorAcademico:
    ...
    def cargar_datos(self):
        ...
        if self.df is None or self.df.empty:
            ...
            print(
                "No existen datos en HistorialAcademico."
            )
        ...
        print(
            f"Estudiantes: "
            f"{self.df['ID_ESTUDIANTE'].nunique()}"
        )
    ...
    def analizar_promedios(self):
        ...
        promedio_semestre = self.df[
            "PROMEDIO_SEMESTRE"
        ].mean()

        promedio_acumulado = self.df[
            "PROMEDIO_ACUMULADO"
        ].mean()

        print(
            f"Promedio semestral: "
            f"{promedio_semestre:.2f}"
        )

        print(
            f"Promedio acumulado: "
            f"{promedio_acumulado:.2f}"
        )
    ...
    # ==========================================================
    # PUNTAJE DE RIESGO DE DESERCIÓN
    # ==========================================================
    ...
    def ejecutar(self):
        ...
        indicadores = (
            self.indicadores_por_estudiante()
        )
        ...
        indicadores = (
            self.analizar_riesgo_academico(
                indicadores
            )
        )
        ...
        indicadores = (
            self.calcular_riesgo_desercion(
                indicadores
            )
        )
